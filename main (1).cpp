...
int main() {
    ...
    string help=" n for new player entry\n m for match score update\n";
    help+=" d for disciplinary action\n r for ranking the players in this game\n";
    help+=" e if you want to edit score parameters\n a if you want to move on to the next game\n";
    help+=" any other input will terminate the program and reveal the result\n";
    int s, b, c, id=0;
    cout<<" !!!Welcome to Hogwarts Wizardry Contest!!!\n \n";
    cout<<help;
    while (1){
        cout<<"Enter your choice of operation (h for help): ";
        cin>>opt;
        switch (opt){
            case 'h':
                cout<<help;
